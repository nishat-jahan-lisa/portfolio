...
knack for crafting robust and scalable web applications. With 5 years of hands-on experience, 
...
export const EXPERIENCES = [
  {
    ...
    company: "Google Inc.",
    description: `Led a team in developing and maintaining web applications using JavaScript, 
    React.js, and Node.js. Implemented RESTful APIs and integrated with MongoDB databases. 
  ...
  },
  {
    ...
    Managed databases and implemented data storage solutions using MongoDB. Worked closely with product managers 
